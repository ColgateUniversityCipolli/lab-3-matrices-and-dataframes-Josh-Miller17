...
(A.determinant <- det(A)) # found determinant of A
```
The  is slightly thinner and longer as compared to the shape in question 1, however it is now more of a rhombus shape. The area stays the exact same as in question 1.
